...
\begin{enumerate}
    ...
    \item \textbf{Fourier Positional Encoding:} 2D coordinates are mapped into a 16-dimensional frequency space to filter noise and motion blur \cite{garcia2025fourier}.
    \item \textbf{Binary Matching Engine:} Utilizes bitwise operations (XOR and population count) for rapid descriptor matching \cite{wu2023binary}.
\end{enumerate}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{figures/fig2_feature_stack.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{figures/fig3_matching_engine.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{figures/fig4_experiment_setup.png}}
